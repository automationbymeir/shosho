...
export class PhotographyPortfolioRenderer {
    ...
    renderPhotoSlot(page, slot, photo) {
        ...
        if (photo) {
            container.dataset.selectableId = photo.id || slot.slotId;
        }
    ...
    renderEmptySlot(page, slot, index) {
        ...
        // Mark as empty slot with index for drop handling
        ...
        container.style.cssText = `
            ...
            cursor: pointer;
        `;
        container.innerHTML = '<span style="color:rgba(255,255,255,0.5); font-size: 24px; pointer-events: none;">+</span>';
        page.appendChild(container);
    }
